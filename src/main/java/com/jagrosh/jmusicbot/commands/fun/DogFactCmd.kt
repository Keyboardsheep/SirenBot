...
class DogFactCmd(bot: Bot) : BaseCatCmd() {
    var log = LoggerFactory.getLogger("DogFactCmd")
    ...
    private val doggoFact: String
        // Body contains your json stirng
        private get() {
            val httpclient: HttpClient = DefaultHttpClient()
            return try {
                val httpget = HttpGet("https://some-random-api.ml/facts/dog")
                ...
                try {
                    ...
                    ) as List<*>)[0] as Map<*, *>)["fact"] as String
