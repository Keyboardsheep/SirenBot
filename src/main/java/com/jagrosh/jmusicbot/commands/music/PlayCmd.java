    ...
    public void doCommand(CommandEvent event) {
        if (event.getArgs().isEmpty() && event.getMessage().getAttachments().isEmpty()) {
            ...
            EmbedBuilder ebuilder = new EmbedBuilder()
                    ...
                    .setTitle(event.getClient().getWarning() + " Play Commands:\n")
                    .setDescription("`" + event.getClient().getPrefix() + "play <song title>` - plays the first result from Youtube" +
                            "\n`" + event.getClient().getPrefix() + "play <URL>` - plays the provided song, playlist, or stream" +
                            "\n`" + event.getClient().getPrefix() + "play playlist <name>` - plays the provided playlist");
